    ...
    "basic": [{
        ...
        "menus":
			[{//三级菜单
				  ...
				  "menus": [{
					  //根节点
				      "menuid": "foreground_user_manage",
				      "menuname": "前台用户管理",
				      "icon": "icon-nav",
					  "menus": [{
						  		"menuid": "ban_foreground_user",
						  		"menuname": "封禁用户",
						  		"icon": "icon-nav",
						  		"url":"/BookStore/backstage/UserServlet?methodName=findPageWithIsBan"
					  }]
				      },{
				      "menuid": "backstage_user_manage",
				      "menuname": "后台用户管理",
				      "icon": "icon-nav",
					  "menus": [{
						  		"menuid": "ban_backstage_user",
						  		"menuname": "封禁用户",
						  		"icon": "icon-nav",
						  		"url":""						  
					  },{
					  		"menuid": "create_backstage_user",
					  		"menuname": "创建用户",
					  		"icon": "icon-nav",
					  		"url":""						  
					  }]
				  ...
				  "menus": [{
				      ...
				      "menuname": "图书分类列表",
				      "icon": "icon-nav",
					  "url":"/BookStore/backstage/CategoryServlet?methodName=findAll"
				      }]
				  },{//三级菜单
				  "menuid": "book_manage",
				  "menuname": "图书管理",
				  ...
				  "menus": [{
				      ...
				      "menuname": "查找图书",
				      "icon": "icon-nav",
					  "url":"/BookStore/adminjsps/admin/book/main.jsp"
				      },{
				      "menuid": "putaway_book",
				      "menuname": "图书上架",
				      "icon": "icon-nav",
					  "url":"/BookStore/backstage/BookServlet?methodName=putAwayPre"
					 }]
				  },{//三级菜单
				  "menuid": "trade_manage",
				  "menuname": "订单管理",
				  ...
				  "menus": [{
					  ...
					  "menus": [{
					      ...
					      "menuname": "发货记录列表",
					      "icon": "icon-nav",
						  "url":"/BookStore/backstage/HandleServlet?methodName=findPageWithOperateAndStatus&operate=1"
					  }]
				      },{
					      "menuid": "refund_manage",
					      "menuname": "退款管理",
					      "icon": "icon-nav",
						  "menus": [{
						      "menuid": "refund_list",
						      "menuname": "退款记录列表",
						      "icon": "icon-nav",
							  "url":"/BookStore/backstage/HandleServlet?methodName=findPageWithOperateAndStatus&operate=2"							  
						  }]
					      }]
				  }
]
                    ...
                    $('#loginOut').click(function() {
                        $.messager.confirm('系统提示', '您确定要退出本次登录吗?', function(r) {
                            ...
                            if (r) {
                                ...
                                location.href = "/BookStore/backstage/BackStageUserServlet?methodName=exit";
                            }
                        });
                    })
                });
