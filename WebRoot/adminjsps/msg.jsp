...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 50px;"><c:if test="${empty sessionScope.backstageuser }"><a target="_top" href="<c:url value='/adminjsps/login.jsp'/>">登录</a></c:if></span>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/adminjsps/admin/enter.jsp'/>">首页</a></span>
	  </div>
	</div>
</div>
