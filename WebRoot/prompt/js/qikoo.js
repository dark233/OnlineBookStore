...
return r.find(".console-btn-confirm").click(function() {
...
}, qikoo.dialog.addToCartNotice = function(e, t, n) {
    e = e || function() {
    ...
    var r = qikoo.dialog.show({
        html: ['<div class="dialog-content" style="padding: 0 80px; text-align:left">', '<div class="content-title2">添加到购物车成功。</div>', '<p style="padding-left: 50px">按情况点击以下按钮：</p>', "</div>", '<div class="dialog-console clearfix_new" style="margin:25px auto;width:252px;">','<a class="console-btn-confirm" href="#" onclick="return false;">继续购物</a>','<a class="console-btn-cancel" href="#" onclick="return false;">去购物车</a>',"</div>"].join(""),
        width: 530,
        closeFn: n
    });
