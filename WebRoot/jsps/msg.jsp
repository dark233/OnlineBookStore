...
a:not(.topa) {text-decoration: none;}
a:visited:not(.topa) {color: #018BD3;}
a:hover:not(.topa) {color:#FF6600; text-decoration: underline;}
}
</style>
  ...
  <body>
   ...
   <c:choose>
  	...
  	<c:when test="${code eq 'failed' }"><!-- 如果code是failed，它显示错号图片 -->
...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 50px;"><c:if test="${empty sessionScope.user }"><a target="_top" href="<c:url value='/jsps/user/login.jsp'/>">登录</a></c:if></span>
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/enter.jsp'/>">首页</a></span>
	  </div>
	</div>
</div>
