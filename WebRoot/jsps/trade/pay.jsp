...
<html>
  ...
  <body>
	...
	<div class="divContent">
		<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${trade.tradeMoney }</span>
		<span class="spanTradeid">编号：${trade.tradeid }</span>
	</div>
	...
	<form action="<c:url value='/TradeServlet'/>" method="post" id="form1" target="_top">
		<div class="divPayway">
			...
			<div style="margin-left: 20px;">
				<input id="pay_way1" type="radio" name="pay_way" value="pw-01" checked="checked"/>余额支付
				<input id="pay_way2" type="radio" name="pay_way" value="pw-02"/>易宝支付
			</div>
		</div>
		...
		<div class="divMypay">
			<div class="divText">输入支付密码:</div>
			<div style="margin-left: 20px;">
				 <div style="margin-bottom: 20px;">
					<input id="pay_pwd" type="password" name="pay_pwd" placeholder="输入支付密码" required="required"/>
