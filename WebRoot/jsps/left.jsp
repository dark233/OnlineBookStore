 ...
 * 1. 对象名必须与第一个参数相同！
   2. 第二个参数是显示在菜单上的大标题
 */
var bar = new Q6MenuBar("bar", "NETBOOKSTORE");
$(function() {
...
<c:forEach items="${parents}" var="parent">
  <c:forEach items="${parent.children}" var="child">
	bar.add("${parent.cname}", "${child.cname}", "/BookStore/BookServlet?methodName=findByCategory&cid=${child.cid}", "body");
  </c:forEach>
</c:forEach>
/* 	bar.add("一级分类", "二级分类", "https://www.baidu.com", "body");
